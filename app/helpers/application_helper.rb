module ApplicationHelper
	...
	def create_transactions(item, order)
		...
		item.product.user.transactions.create(admin_commision: @admin_comision, tax: @tax, seller_earning: @seller_earnings, total_amount: @price, product: item.product.product_name, order_id: order.id, quantity: item.quantity)
	end
end